...
| G3 行与卡 | Row · RowDetail · Card · InfoCard · **Section** · Field · Kv · ThinTable · **RefPill**（+ **AnTwoZone** 右锚两区共享原语 · AnEditableValue · AnAutoGrid） | ⏳（G3.1 AnTwoZone · G3.2 地基增强 · G3.3 RefPill · G3.4 Section 已落） |
