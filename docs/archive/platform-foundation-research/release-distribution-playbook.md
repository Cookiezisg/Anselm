...
audience: [human, ai]
landed-into: docs/working/platform-foundation/release-distribution-playbook.md
---

# WRK-043 — 发行与分发 Playbook(三平台,可照敲)

> **冻结历史快照，不再“可照敲”。** 本页的账号、价格、证书、平台政策、包选择和
> CI 建议停留在 2026-06-26。执行任何发行工作前必须重新查 Apple、Microsoft、
> Linux 发行目标、GitHub 与所选工具的当前官方文档。当前发行 draft 见
> [`working/platform-foundation/release-distribution-playbook.md`](../../working/platform-foundation/release-distribution-playbook.md)。
