...
| 架构决策（直装运行时 / 统一错误类型 / API 契约 / Flutter / mise / MCP / scheduler / 主密钥 / editor / gateway 设备证明 / 媒体 lease 契约 / 媒体内联上游 / 视频同步工具 / MediaRef 唯一货币 / 受管视频签名句柄 / 内联播放 media_kit / 产地决定模型输入） | `decisions/000{1,2,3,4,5,6,7,8,9}-*.md` · `decisions/001{0,1,2,3,4,5,6,7}-*.md` |
