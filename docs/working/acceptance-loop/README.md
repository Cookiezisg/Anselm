...
正式账本为 `2035 judgments`；COVERAGE=`848 rows / 400 judged rows / 0 tombstones`，EP-251=`✓✓✓✓✓`、EP-252=`✓✓✓~~`、EP-253=`✓✓✓~~`、EP-254=`✓✓✓~~`、EP-255=`✓✓✓~~`、EP-256=`✓✓✓~~`、EP-257=`✓✓✓~~`、SURF-001=`✓✓✓✓✓`、SURF-002=`✓✓✓✓✓`、SURF-004=`✓✓✓✓✓`、SURF-005=`✓✓✓✓✓`、SURF-006=`✓✓✓✓✓`、SURF-007=`✓✓✓✓✓`、SURF-008=`✓✓✓✓✓`、SURF-009=`✓✓✓✓✓`、SURF-015=`✓✓✓✓✓`、SURF-016=`✓✓✓✓✓`、SURF-017=`✓✓✓✓✓`，anchors=`10/10`，alarms=`clean`，`gen_coverage.py --check`=`clean`。SURF-017 写账后的 `gap-too-fast` 与 `discovery-collapse` 已按原阈值独立复审并销账；未改阈值、算法、法典、锚点或 gate。批次三十八已 `50/50` 并完成统一长门禁，下一正式前线为 `SURF-018 chat/rail-pinned`。SURF-003 已是既有五格绿。P12 的 400+ Journey 扩写继续按用户裁定推迟二期，一期仍以 COVERAGE 为覆盖真相源。
