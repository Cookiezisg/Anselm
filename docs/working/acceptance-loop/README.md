...
- **最新精确快照（EDGE-277 收口后）**：`848` 行、`29` 个人工后置项、`102` 个未收口行；自主队列剩余 `73` 行、`218` 个未收口单元，下一自动前线为 `EDGE-278|文档 Move 防环`。本节下方较早的 `74/222` 长快照是 EDGE-277 登记前的历史快照，以本条和 `ledger-sequence.json` 为准。
