...
| TOOL-006 | Grep | search · ripgrep 正则内容检索,三种输出模式 | ····· |  |
| TOOL-007 | Bash | shell · 执行 shell 命令,支持 run_in_background | ····· |  |
| TOOL-008 | BashOutput | shell · 拉取后台 Bash 新增输出+状态 | ····· |  |
| TOOL-009 | KillShell | shell · 按 bash_id 终止后台 Bash(幂等) | ····· |  |
| TOOL-010 | ask_user | ask · 向用户提问并阻塞等待(humanloop broker) | ····· |  |
| TOOL-011 | todo_write | todo · 整体覆盖写本对话任务清单 | ····· |  |
| TOOL-012 | todo_read | todo · 读回当前任务清单含已完成项 | ····· |  |
| TOOL-013 | search_tools | toolset · 按能力检索并激活 lazy 工具 | ····· |  |
| TOOL-014 | search_function | function · 关键词+语义检索 function 库 | ····· |  |
| TOOL-015 | get_function | function · 取 function 活跃版本全貌 | ····· |  |
| TOOL-016 | create_function | function · ops 构建新 Python function,v1 立即生效 | ····· |  |
| TOOL-017 | edit_function | function · 活跃版本叠 ops 出新版本 | ····· |  |
| TOOL-018 | revert_function | function · 活跃指针切到已有版本号 | ····· |  |
| TOOL-019 | delete_function | function · 删 function 全版本+环境,不可逆 | ····· |  |
| TOOL-020 | update_function_meta | function · 仅改 name/description/tags | ····· |  |
| TOOL-021 | run_function | function · 关键字参数运行,返回 ok/output/logs | ····· |  |
| TOOL-022 | search_function_executions | function · 分页检索执行历史 | ····· |  |
| TOOL-023 | get_function_execution | function · 取单条执行记录 | ····· |  |
| TOOL-024 | search_handler | handler · 检索 handler 库 | ····· |  |
| TOOL-025 | get_handler | handler · 取活跃版本+配置态+运行态 | ····· |  |
| TOOL-026 | create_handler | handler · 新建有状态常驻 Python 类 | ····· |  |
| TOOL-027 | edit_handler | handler · 叠 ops 新版本并重启实例 | ····· |  |
| TOOL-028 | revert_handler | handler · 切版本并重启实例 | ····· |  |
| TOOL-029 | delete_handler | handler · 停实例删全版本,不可逆 | ····· |  |
| TOOL-030 | call_handler | handler · 调用常驻实例方法 | ····· |  |
| TOOL-031 | update_handler_config | handler · Merge Patch 写 init-args 后重启 | ····· |  |
| TOOL-032 | update_handler_meta | handler · 仅改 meta,不重启 | ····· |  |
