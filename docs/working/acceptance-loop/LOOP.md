...
- 批次八十三由 `49→50/50` 后完成统一批次门禁、完整回归、警报复核、工作树审计和提交准备；收口证据=`testend/rig/formal-evidence/batch-83-unified-gate-20260829.md`，下一批从 `0/50` 开始。P12 的 400+ Journey 扩写按用户裁定推迟二期。
