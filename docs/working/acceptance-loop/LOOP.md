...
## 当前前线覆盖声明（2026-08-26 · EDGE-240 已收口 · 批次七十一 50/50，统一门禁通过，已提交=a12a0e03）
...
- formal journal=`3686`（2300 baseline + 1386 live），`COVERAGE=848/737/0`，`anchors=10/10`，
  `alarms.py check` clean；50 格统一长门禁全绿，证据=`testend/rig/formal-evidence/batch-71-unified-gate-20260826.md`，
  已提交=`a12a0e03`。下一原子前线=`EDGE-241`。P12 400+ Journey 按用户裁定推迟二期。
