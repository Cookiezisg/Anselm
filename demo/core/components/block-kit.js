/* Forgify demo — 组件 block-kit（chat teaching-spine 块工厂；单一事实源，收掉 oceans/chat 内联的 toolGroup/toolItem/progressBox/resultBox/reasonBlock/ledger/dock/subtree/turnEnd/compaction）。
