...
(function () {
  ...
  const REPORT = {
    nodes: [n('cron', 'trigger', 'cron_2am', 24, 150), n('fetch', 'action', 'fetch_news', 224, 40), n('parse', 'action', 'parse_pdf', 224, 260), n('summarize', 'agent', 'research_agent', 424, 150), n('route', 'control', 'route_by_amount', 624, 150), n('publish', 'action', 'slack_handler', 824, 40), n('notify', 'approval', 'manager_approval', 824, 260)],
  ...
  window.MOCK_WORKFLOWS = {
    '研报抓取流': { st: 'run', meta: '运行中 4/7', cur: 1, runs: [
      { id: 'fr_29f1a4', runState: 'completed', version: 'v8', trigger: 'cron_2am', when: '昨天 02:00', pos: '7/7', ...REPORT,
      ...
      { id: 'fr_3a9c2f', runState: 'running', version: 'v8', trigger: 'cron_2am', when: '今天 02:00', pos: '4/7', ...REPORT,
    ...
    '竞品监控流': { st: 'wait', meta: '等你审批', cur: 0, runs: [
      { id: 'fr_71d0e8', runState: 'running', version: 'v3', trigger: 'webhook_pr', when: '14:22', pos: '4/5',
    ...
    '账单对账流': { st: 'err', meta: '失败 · 2m', cur: 0, runs: [
      { id: 'fr_5b3c10', runState: 'failed', version: 'v3', trigger: null, when: '13:40', pos: '2/4', replay: 1,
    ...
    '日报汇总流': { st: 'done', meta: '今天 9:02', cur: 0, runs: [
      { id: 'fr_18aa3c', runState: 'completed', version: 'v5', trigger: 'cron_9am', when: '今天 09:02', pos: '4/4',
