...
## 4. Cross-domain seams (16 / 81 covered, 20%)
...
| workflow_scheduler:agent_substep_replay | agent 节点每个 ReAct 步记 agent_step_completed → :replay 重建历史跳过已完成步(ADR-010) | backend/test/cross/workflow_attach_pipeline_test.go::TestWorkflow_AgentNode_JournalsSubSteps_E2E |
