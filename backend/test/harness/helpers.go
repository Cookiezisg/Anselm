...
// ErrEnvelope decodes the standard error envelope.
//
// ErrEnvelope 解标准错误 envelope。
...
//
// DoRequest 发 JSON 请求返状态码，非 2xx 不 fatal。
...
//
// UploadFile 把 data 作 multipart 上传到 /api/v1/attachments。
