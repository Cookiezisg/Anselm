...
var (
	...
	// or deleted. ErrManaged：内置、后端开通的凭证（免费档网关）不可编辑、不可删除。
	ErrManaged = errorspkg.New(errorspkg.KindUnprocessable, "API_KEY_IMMUTABLE", "managed api key cannot be edited or deleted")
)
