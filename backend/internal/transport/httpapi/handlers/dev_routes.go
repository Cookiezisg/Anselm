...
// devRoutes is the hand-maintained mirror of every mux.HandleFunc in this package.
//
...
// Routes serves GET /dev/routes — the route manifest.
//
// Routes 服务 GET /dev/routes,返路由 manifest。
