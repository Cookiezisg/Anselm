...
func New(deps Deps) http.Handler {
	...
	if deps.Dev {
		handlershttpapi.NewDevHandler(deps.DB, deps.LogBroadcaster, deps.CollectionsDir, deps.IntegrationDir, deps.Port, deps.Tools, deps.LLMFactory, deps.Log).Register(mux)
	}
