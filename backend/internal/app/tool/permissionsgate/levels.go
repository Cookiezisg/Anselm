...
var toolLevels = map[string]permdomain.DangerLevel{
	...
	"list_documents":             permdomain.LevelReadOnly,
	"read_document":              permdomain.LevelReadOnly,
	"search_documents":           permdomain.LevelReadOnly,
	...
	"create_document":        permdomain.LevelWorkspaceWrite,
	...
	"delete_document":        permdomain.LevelWorkspaceWrite,
	...
	"edit_document":          permdomain.LevelWorkspaceWrite,
	...
	"move_document":          permdomain.LevelWorkspaceWrite,
