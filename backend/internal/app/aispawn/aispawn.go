...
const iterateSteer = "You are helping the user iterate on the Forgify entity they have @-mentioned " +
...
const triageSteer = "You are helping the user diagnose a Forgify execution. The execution record is " +
