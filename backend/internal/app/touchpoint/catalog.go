...
var catalog = map[string]rule{
	...
	"get_workflow":               {kind: relationdomain.EntityKindWorkflow, verb: touchpointdomain.VerbViewed, outputKey: "id"},
	...
	"capability_check_workflow":  {kind: relationdomain.EntityKindWorkflow, verb: touchpointdomain.VerbViewed, outputKey: "id"},
