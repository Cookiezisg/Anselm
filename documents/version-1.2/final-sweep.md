...
| §14 | Phase 5 真正没做的 | 2 / 7 | 🟡 起步 | 愿景核心；§14.1 4 层 + §14.2 HTTP 7 端点 + testend 烟雾层全到位（commit `895c18f`，49 测试全绿）；§14.3 system tools 接下来。Notion 树 UI + workflow/conv 挂载留 §14.5。详 [`service-design-documents/document.md`](./service-design-documents/document.md) |
