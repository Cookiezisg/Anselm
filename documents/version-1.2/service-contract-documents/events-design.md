...
### entity-state 模型（Phase 6 重构 · 2026-05-02；Phase 5 加 task · 2026-05-04；Phase 4 准备件加 mcp/skill + chat.message 加 subagent 字段 · 2026-05-05）
