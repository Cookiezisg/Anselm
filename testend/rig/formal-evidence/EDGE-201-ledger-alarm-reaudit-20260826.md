# EDGE-201 ledger and alarm re-audit

- `judge.py` 五级账本写入：L1 `pass`，L2-L5 `na`
- L1 law: `measure:edge201-attachment-missing-blob-replay`
- Evidence: `formal-evidence/EDGE-201-attachment-missing-blob-replay-20260826.md`
