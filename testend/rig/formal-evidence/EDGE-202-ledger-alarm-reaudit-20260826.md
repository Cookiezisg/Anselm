# EDGE-202 ledger and alarm re-audit

- `judge.py` 五级账本写入：L1 `pass`，L2-L5 `na`
- L1 law: `measure:edge202-attachment-audio-playback-token-expiry`
- Evidence: `formal-evidence/EDGE-202-attachment-audio-playback-token-expiry-20260826.md`
