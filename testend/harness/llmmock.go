...
// MockPNG is a decoder-valid 1×1 RGB PNG every mocked image generation returns — scenarios assert
// the stored attachment's bytes equal it, proving the whole artifact pipeline end to end.
//
