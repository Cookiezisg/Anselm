      ...
      <div className="page-header" style={{ paddingTop: 18 }}>
        <div className="page-header-text" style={{ gap: 6 }}>
          ...
          <div className="page-subtitle">
            由 <code style={{ fontFamily: "var(--font-mono)" }}>{fr.trigger}</code> 触发 · <RelTime ts={fr.startedAt} /> · 
    ...
    <div className="page">
      <div className="page-header">
        <div className="page-header-text">
          ...
          <div className="page-subtitle">Workflow 运行历史 · 节点级 inspector · 非线性 DAG 可视化</div>
        </div>
        <div className="page-actions">
