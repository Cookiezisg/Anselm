...
mixin _$NotificationItem {
 ...
 String get id; String get type; Map<String, dynamic> get payload; DateTime? get readAt; DateTime get createdAt;
...
@override
String toString() {
  return 'NotificationItem(id: $id, type: $type, payload: $payload, readAt: $readAt, createdAt: $createdAt)';
}
...
@useResult
$Res call({
 String id, String type, Map<String, dynamic> payload, DateTime? readAt, DateTime createdAt
});
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String id,  String type,  Map<String, dynamic> payload,  DateTime? readAt,  DateTime createdAt)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _NotificationItem() when $default != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String id,  String type,  Map<String, dynamic> payload,  DateTime? readAt,  DateTime createdAt)  $default,) {final _that = this;
switch (_that) {
case _NotificationItem():
return $default(_that.id,_that.type,_that.payload,_that.readAt,_that.createdAt);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String id,  String type,  Map<String, dynamic> payload,  DateTime? readAt,  DateTime createdAt)?  $default,) {final _that = this;
switch (_that) {
case _NotificationItem() when $default != null:
return $default(_that.id,_that.type,_that.payload,_that.readAt,_that.createdAt);case _:
  return null;
...
class _NotificationItem extends NotificationItem {
  const _NotificationItem({required this.id, required this.type, final  Map<String, dynamic> payload = const <String, dynamic>{}, this.readAt, required this.createdAt}): _payload = payload,super._();
