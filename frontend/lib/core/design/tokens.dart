...
abstract final class AnSize {
  ...
  static const double quoteBar = 2; // blockquote left rule (editor / markdown / gate free-text answer — ONE width) 引用块左条(编辑器/markdown/人闸自由答复,统一宽)
  ...
  static const double pagerJumpW = 44; // AnPager jump cell: «#» glyph + 3 digits — the WORD no longer sizes the box (0718 拍板) 翻页器跳页小格:记号+3位数,词不再定宽
