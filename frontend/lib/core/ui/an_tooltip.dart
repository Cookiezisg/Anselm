...
/// skin: island surface + hairline border + pop shadow + the 12 meta rung, 500ms reveal so casual
/// mouse travel never flashes labels. Restraint on purpose (enterprise calm): no arrow, no rich
/// body — a rich variant is a later need, not a default.
///
/// kit 提示条——Flutter [Tooltip] 机制(计时/悬停/长按/语义合并/overlay 生命周期:成熟件不手搓,
/// 原则 #8)穿设计系统的皮:岛面+发丝边+pop 影+12 meta 档,500ms 才现——鼠标路过绝不闪标签。
