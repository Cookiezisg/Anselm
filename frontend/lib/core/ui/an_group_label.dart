...
/// A thin section/group caption (uppercase · meta size · w400 · faint ink) — the single source for
...
///
/// 极薄分组/段小标题(uppercase · meta · w400 · faint 墨)——分组标签的单源。纵向内距按邻近原则:上多(分隔)、下少(贴附本组)。
///
  ...
  Widget build(BuildContext context) {
    return Padding(
      ...
      child: Text(
        ...
        style: AnText.meta.weight(AnText.emphasisWeight).copyWith(color: context.colors.inkFaint),
      ),
    );
  }
}
