...
/// A thin section/group caption (uppercase · meta size · 600 · faint ink) — the single source for
...
///
/// 极薄分组/段小标题(uppercase · meta · 600 · faint 墨)——分组标签的单源。纵向内距按邻近原则:上多(分隔)、下少(贴附本组)。
