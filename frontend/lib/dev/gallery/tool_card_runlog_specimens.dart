...
BlockNode _search(String name, String args, String result) =>
...
final toolCardRunlogGalleryItem = GalleryItem(
  ...
  [
    GallerySpecimen(
      'search_function_executions · 混合(ok/failed/timeout 珠 + hasMore)',
      (c) => ChatToolCard(
        node: _search(
    ...
    GallerySpecimen(
      'search_handler_calls · method() chip + instanceId 次行',
      (c) => ChatToolCard(
        node: _search(
          'search_handler_calls',
          '{"handlerId":"hd_5c4b3a2f1e0d9c8b"}',
          _page(
            'calls',
            [
              _exec(
                ...
                'ok',
                by: 'agent',
                extra: ',"method":"charge","instanceId":"inst_88a1"',
              ),
              _exec(
                'hdcall_02',
                'failed',
                by: 'chat',
                extra: ',"method":"refund","instanceId":"inst_88a1"',
              ),
            ],
            ok: 12,
            failed: 1,
    ...
    GallerySpecimen(
      'search_agent_executions · timeout 琥珀珠(transcript 已丢弃)',
      (c) => ChatToolCard(
        node: _search(
          'search_agent_executions',
          '{"agentId":"ag_9f8e7d6c5b4a3f2e"}',
          _page(
            'executions',
            [
              ...
              _exec(
                ...
                'ok',
                elapsed: 8400,
                extra: ',"transcript":"[...30KB of blocks...]"',
              ),
              _exec(
                'agexec_02',
                'timeout',
    ...
    GallerySpecimen(
      'search_function_executions · 无记录(回执即卡、无体)',
      (c) => ChatToolCard(
        node: _search(
          'search_function_executions',
          '{"functionId":"fn_never_run"}',
    ...
    GallerySpecimen(
      'search_flowruns · 珠串本页 + replay 微章 + 失败 subtext',
      (c) => ChatToolCard(
        node: _search(
          'search_flowruns',
            ...
            'runs': [
              {
                ...
                'updatedAt': '2026-07-05T14:03:00Z',
              },
              {
                'id': 'fr_02',
                'workflowId': 'wf_1',
                ...
                'startedAt': '2026-07-05T14:02:00Z',
              ...
              },
              {
                ...
                'updatedAt': '2026-07-05T14:01:00Z',
              },
            ],
            'hasMore': false,
          }),
    ...
    GallerySpecimen(
      'search_firings · 处置词章五色 + started 缀 flowrunId',
      (c) => ChatToolCard(
        node: _search(
          'search_firings',
          ...
          jsonEncode({
            ...
            'firings': [
              ...
              },
              {
                ...
                'activationId': 'act_3',
                'status': 'pending',
                'dedupKey': 'cron:2026-07-05T15',
                'createdAt': '2026-07-05T15:03:00Z',
              },
            ],
          }),
        ),
    ...
    GallerySpecimen(
      'search_activations · fire 标记 + returnValue 惰性行内树',
      (c) => ChatToolCard(
        node: _search(
          'search_activations',
          '{"triggerId":"trg_7a8b9c0d1e2f3a4b"}',
