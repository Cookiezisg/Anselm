...
final GalleryItem anMarkdownGalleryItem = GalleryItem(
  ...
  [
    ...
    GallerySpecimen(
      ...
      (c) => Row(
        ...
        children: [
          ...
          Expanded(
            child: _scaled(c, '嵌入档 · 正文13 · 标题15/13', _mdEmbedded(_dualDoc)),
          ),
        ],
      ),
      span: true,
      ...
      (c) => Column(
        ...
        children: [
          ChatTurn(
            ...
            child: Text(
              '帮我看下为什么失败',
              style: AnText.body.copyWith(color: c.colors.ink),
            ),
          ),
    ...
    GallerySpecimen(
      '空',
      (_) => Padding(padding: const EdgeInsets.all(1), child: _md('')),
      stress: true,
      span: true,
      maxWidth: _mdW,
    ),
