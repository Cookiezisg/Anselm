  ...
  [
      ...
      (c) => _turn(
        ...
        mentions: const [
          MentionSnapshot(
            ...
            id: 'fn_1',
            name: '新名字',
          ), // renamed source text → literal 原文未含新名→字面
          MentionSnapshot(
            type: 'function',
            id: '',
            name: '找不到的',
    ...
    GallerySpecimen(
      ...
      (c) => _turn(
        ...
        mentions: [
          MentionSnapshot(type: 'workflow', id: 'wf_1', name: '实体名超长' * 16),
        ],
        attachments: [
          UserAttachment(
            id: 'a',
            kind: 'document',
            filename: '${'超长文件名' * 40}.pdf',
            sizeBytes: 1024,
          ),
        ],
      ),
    ...
    GallerySpecimen(
      ...
      (c) => _turn(
        ...
        mentions: [
          for (var i = 0; i < 8; i++)
            MentionSnapshot(type: 'function', id: 'fn_$i', name: '实体$i'),
        ],
        attachments: [
          for (var i = 0; i < 6; i++)
            UserAttachment(
    ...
    GallerySpecimen(
      '注入(RTL 覆写/script 文件名/正则元字符实体名)',
      (c) => _turn(
        c,
        text: r'调 @a.*b(x) 处理 一下',
        mentions: const [
          MentionSnapshot(type: 'function', id: 'fn_x', name: r'a.*b(x)'),
        ],
        attachments: const [
          UserAttachment(
            id: 'a',
