  ...
  GallerySpecimen(
    ...
    (_) => const Column(
      ...
      children: [
        ...
        SizedBox(height: 8),
        AnCelGrow(
          expression: 'has(payload.retry) ? payload.retry.count : 0',
          compact: true,
        ),
      ],
    ),
    ...
    (_) => Column(
      children: [
        AnCastRow(
          ...
          lastAt: _ago(const Duration(seconds: 30)),
        ),
        AnCastRow(
          kind: 'document',
          name: '季度复盘',
          ...
          count: 3,
          lastAt: _ago(const Duration(minutes: 20)),
        ),
        AnCastRow(
          kind: 'workflow',
          name: 'nightly_rollup',
          verb: TouchpointVerb.executed,
          lastAt: _ago(const Duration(hours: 5)),
        ),
        AnCastRow(
          kind: 'agent',
          name: 'auditor',
    ...
    (_) => Column(
      children: [
        ...
        AnCastRow(
          ...
          tombstoned: true,
          lastAt: _ago(const Duration(hours: 2)),
        ),
        AnCastRow(
          kind: 'memory',
          name: 'mem_a1b2c3d4e5f6a7b8',
          nameIsRawId: true,
          verb: TouchpointVerb.created,
          lastAt: _ago(const Duration(minutes: 9)),
        ),
      ],
    ),
    span: true,
