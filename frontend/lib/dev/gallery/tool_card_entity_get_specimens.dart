...
const _raw =
    '{"id":"fn_1a2b3c4d5e6f7a8b","name":"fetch_with_retry","description":"指数退避重试,最多 5 次",'
    ...
    GallerySpecimen(
      ...
      (c) => EntityGetBody(
        header: const ToolEntityHeader(
          ...
          id: 'fn_1a2b3c4d5e6f7a8b',
          meta: 'v3 · 2026-07-01 09:00',
        ),
        badges: Wrap(
          spacing: AnGap.inline,
          children: const [AnChip('env ready', tone: AnTone.ok)],
        ),
        kv: const AnKv(
          rows: [
