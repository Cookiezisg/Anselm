...
BlockNode _get(String name, String result) =>
...
final toolCardGetGalleryItem = GalleryItem(
  ...
  [
    ...
    GallerySpecimen(
      'get_agent · 能力药丸(tools/knowledge)+ prompt 窗',
      (c) => ChatToolCard(
        node: _get(
          'get_agent',
    ...
    GallerySpecimen(
      'get_skill · allowedTools 警示 + body 窗',
      (c) => ChatToolCard(
        node: _get(
          'get_skill',
    ...
    GallerySpecimen(
      'read_document · 排版稿子(渲染 markdown)',
      (c) => ChatToolCard(
        node: _get(
          'read_document',
