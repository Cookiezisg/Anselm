...
class NotificationRow extends StatelessWidget {
  ...
  // A read row's icon dims to inkFaint regardless of tone (the row is quiet — a row-state dimming, not a
  // tone mapping); unread keeps its tone. 已读图标一律 inkFaint(行状态调光、非 tone 映射);未读保留 tone。
