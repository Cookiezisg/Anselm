...
FixtureNotificationRepository demoNotificationRepository() {
  ...
  return FixtureNotificationRepository(
    seed: [
      ...
      n('noti_2', 'workflow.approval_pending', {
        'name': 'deploy_prod',
        'workflowId': 'wf_2',
        'flowrunId': 'fr_8',
        'nodeId': 'approve',
      }, const Duration(minutes: 8)),
      n('noti_3', 'handler.crashed', {
        'name': 'api_host',
        'handlerId': 'hd_1',
      }, const Duration(minutes: 22)),
      n('noti_4', 'function.created', {
        'name': 'fetch_orders',
        'functionId': 'fn_1',
      }, const Duration(minutes: 41)),
      n('noti_5', 'memory.updated', {
        'name': 'user-preferences',
      }, const Duration(hours: 2)),
      n(
        'noti_6',
        'agent.edited',
        {'name': 'triager', 'agentId': 'ag_1'},
        const Duration(hours: 4),
        read: true,
      ),
      // ── yesterday ──
      n('noti_7', 'workflow.attention_changed', {
        'name': 'etl_pipe',
        'workflowId': 'wf_3',
        'needsAttention': true,
      ...
      n(
        ...
        'relation.dependency_broken',
        {
          ...
          'deletedId': 'fn_x',
          'dependents': [
            {'kind': 'agent', 'id': 'ag_1', 'name': 'triager'},
            {'kind': 'workflow', 'id': 'wf_3', 'name': 'etl_pipe'},
          ],
        },
        const Duration(hours: 33),
        read: true,
      ),
      // ── earlier ──
      n(
        'noti_10',
        'workflow.deleted',
        {'name': 'legacy_report', 'workflowId': 'wf_old'},
