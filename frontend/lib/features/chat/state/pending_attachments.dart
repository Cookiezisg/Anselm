...
/// set — uploading (spinner chip) / ready (id in hand) / failed (tap to retry; bytes are kept for it).
/// composer 里的待发附件:本地身份+上传生命周期。uploading(转圈)/ready(拿到 id)/failed(点重试,字节留存)。
