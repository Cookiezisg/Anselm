...
// workflow 的 payload 来源('manual' 或挂载 trigger id):驱动 payload 字段渲染并给草稿分桶。
 ...
 String? get errorCode; String? get errorMsg; Object? get errorDetails;// structured API details, such as a Python traceback 结构化错误细节
 String? get inputError;// form validation (bad JSON in an object/array field) 入参校验错
...
@useResult
$Res call({
 RunPhase phase, String method, String source, Object? output, String? errorCode, String? errorMsg, Object? errorDetails, String? inputError, int elapsedMs, String? logs, int steps, int tokensIn, int tokensOut, String? flowrunId, List<FlowrunNode> flowNodes, String flowrunStatus, int runSeq
});
...
/// Create a copy of RunTerminalState
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? phase = null,Object? method = null,Object? source = null,Object? output = freezed,Object? errorCode = freezed,Object? errorMsg = freezed,Object? errorDetails = freezed,Object? inputError = freezed,Object? elapsedMs = null,Object? logs = freezed,Object? steps = null,Object? tokensIn = null,Object? tokensOut = null,Object? flowrunId = freezed,Object? flowNodes = null,Object? flowrunStatus = null,Object? runSeq = null,}) {
...
as String?,errorDetails: freezed == errorDetails ? _self.errorDetails : errorDetails ,inputError: freezed == inputError ? _self.inputError : inputError // ignore: cast_nullable_to_non_nullable
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( RunPhase phase,  String method,  String source,  Object? output,  String? errorCode,  String? errorMsg,  Object? errorDetails,  String? inputError,  int elapsedMs,  String? logs,  int steps,  int tokensIn,  int tokensOut,  String? flowrunId,  List<FlowrunNode> flowNodes,  String flowrunStatus,  int runSeq)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _RunTerminalState() when $default != null:
return $default(_that.phase,_that.method,_that.source,_that.output,_that.errorCode,_that.errorMsg,_that.errorDetails,_that.inputError,_that.elapsedMs,_that.logs,_that.steps,_that.tokensIn,_that.tokensOut,_that.flowrunId,_that.flowNodes,_that.flowrunStatus,_that.runSeq);case _:
  return orElse();
...
class _RunTerminalState extends RunTerminalState {
  const _RunTerminalState({this.phase = RunPhase.idle, this.method = '', this.source = 'manual', this.output, this.errorCode, this.errorMsg, this.errorDetails, this.inputError, this.elapsedMs = 0, this.logs, this.steps = 0, this.tokensIn = 0, this.tokensOut = 0, this.flowrunId, final  List<FlowrunNode> flowNodes = const <FlowrunNode>[], this.flowrunStatus = '', this.runSeq = 0}): _flowNodes = flowNodes,super._();
...
@override final  Object? errorDetails;
// structured API details, such as a Python traceback 结构化错误细节
...
@override
int get hashCode => Object.hash(runtimeType,phase,method,source,const DeepCollectionEquality().hash(output),errorCode,errorMsg,const DeepCollectionEquality().hash(errorDetails),inputError,elapsedMs,logs,steps,tokensIn,tokensOut,flowrunId,const DeepCollectionEquality().hash(_flowNodes),flowrunStatus,runSeq);
...
/// Create a copy of RunTerminalState
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? phase = null,Object? method = null,Object? source = null,Object? output = freezed,Object? errorCode = freezed,Object? errorMsg = freezed,Object? errorDetails = freezed,Object? inputError = freezed,Object? elapsedMs = null,Object? logs = freezed,Object? steps = null,Object? tokensIn = null,Object? tokensOut = null,Object? flowrunId = freezed,Object? flowNodes = null,Object? flowrunStatus = null,Object? runSeq = null,}) {
