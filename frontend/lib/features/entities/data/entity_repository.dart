...
class LiveEntityRepository implements EntityRepository {
  ...
  static ExecutionAggregates _agg(Map<String, dynamic> data) =>
      ExecutionAggregates.fromJson(
        (data['aggregates'] as Map<String, dynamic>?) ?? const {},
      );
  ...
  Future<Page<EntityRow>> listEntities(
    ...
    kind.base,
    (m) => EntityRow.fromListItem(kind, m),
  ...
  Future<Page<FunctionVersion>> listFunctionVersions(
    ...
    '${EntityKind.function.itemPath(id)}/versions',
  ...
  Future<Page<HandlerVersion>> listHandlerVersions(
    ...
    '${EntityKind.handler.itemPath(id)}/versions',
    HandlerVersion.fromJson,
    query: _query(cursor, limit),
  );
  @override
  Future<Page<AgentVersion>> listAgentVersions(
    ...
    '${EntityKind.agent.itemPath(id)}/versions',
  ...
  listFunctionExecutions(
    ...
    int? limit,
    String? status,
  }) => _api.getPageWithAggregate(
    '${EntityKind.function.itemPath(id)}/executions',
    'executions',
  ...
  Future<PageWithAggregate<HandlerCall, ExecutionAggregates>> listHandlerCalls(
    ...
    '${EntityKind.handler.itemPath(id)}/calls',
    'calls',
    HandlerCall.fromJson,
    _agg,
  ...
  listAgentExecutions(
    ...
    '${EntityKind.agent.itemPath(id)}/executions',
    'executions',
    AgentExecution.fromJson,
    _agg,
    query: _query(cursor, limit, {'status': ?status}),
  );
  ...
  Future<String> triggerWorkflow(String id, {Map<String, dynamic>? payload}) =>
      _api.postForId(
        EntityKind.workflow.actionPath(id)!,
  ...
  @override
  Future<FlowrunComposite> replayFlowrun(String flowrunId) => _api.postEntity(
    '/api/v1/flowruns/$flowrunId:replay',
    FlowrunComposite.fromJson,
  );

  @override
  Future<WorkflowEntity> killWorkflow(String id) => _api.postEntity(
    '${EntityKind.workflow.itemPath(id)}:kill',
  ...
  Future<Page<Activation>> listActivations(
    ...
    '${EntityKind.trigger.itemPath(id)}/activations',
    Activation.fromJson,
  ...
  Future<Page<Firing>> listFirings(
    ...
    '${EntityKind.trigger.itemPath(id)}/firings',
    Firing.fromJson,
    query: _query(cursor, limit, {'status': ?status}),
  );
  ...
  Future<FunctionEntity> patchFunctionMeta(
    ...
    EntityKind.function.itemPath(id),
  ...
  Future<HandlerEntity> patchHandlerMeta(
    ...
    EntityKind.handler.itemPath(id),
  ...
  Future<HandlerConfig> getHandlerConfig(String id) => _api.getEntity(
    '${EntityKind.handler.itemPath(id)}/config',
    HandlerConfig.fromJson,
  );
  ...
  @override
  Future<HandlerEntity> restartHandler(String id) => _api.postEntity(
    '${EntityKind.handler.itemPath(id)}:restart',
    HandlerEntity.fromJson,
  );
  ...
  Future<WorkflowEntity> patchWorkflowMeta(
    ...
    EntityKind.workflow.itemPath(id),
    WorkflowEntity.fromJson,
    body: patch,
  );
  ...
  Future<WorkflowVersion> editWorkflow(
    ...
    '${EntityKind.workflow.itemPath(id)}:edit',
    WorkflowVersion.fromJson,
  ...
  Future<void> revertVersion(EntityKind kind, String id, int version) async =>
      await _api.postEntity(
        '${kind.itemPath(id)}:revert',
        (m) => m,
  ...
  Future<MountHealthReport> getMountHealth(String id) => _api.getEntity(
    '${EntityKind.agent.itemPath(id)}/mount-health',
    MountHealthReport.fromJson,
  );

  // ── ref-picker candidates ──────────────────────────────────────────────────
  // An mcp SERVER is keyed by name (id == name), status is the meta. mcp server 以 name 为键(id=name)。
  @override
  Future<List<RefCandidate>> listMcpServers() async =>
      (await _api.getPage<RefCandidate>(
        '/api/v1/mcp-servers',
        (m) => (
          id: m['name'] as String? ?? '',
          name: m['name'] as String? ?? '',
          meta: m['status'] as String?,
        ),
  ...
  Future<List<RefCandidate>> _refList(
    String path,
  ) async => (await _api.getPage<RefCandidate>(
    path,
    (m) => (
      id: m['id'] as String? ?? '',
