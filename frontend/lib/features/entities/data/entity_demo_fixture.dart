...
import '../../../dev/markdown_corpus.dart'
    show kCorpusMentionId, kCorpusMentionName;
...
FixtureEntityRepository demoEntityRepository() {
  ...
  FunctionVersion fnVer(String fnId, int v, String code, String reason) =>
      FunctionVersion(
        id: '${fnId}_v$v',
        functionId: fnId,
        version: v,
  ...
  FunctionEntity fn(String id, String name, String desc, String code) =>
      FunctionEntity(
        id: id,
        name: name,
        description: desc,
    ...
    activeVersion: HandlerVersion(
      ...
      methods: const [
        MethodSpec(
          ...
          outputs: [Field(name: 'ts', type: 'string')],
          body: 'return self.client.post(...)',
        ),
        MethodSpec(
          name: 'stream',
          body: 'yield from ...',
  ...
  WorkflowVersion wfVer(String id, int version, String g, String reason) =>
      WorkflowVersion(
        id: '${id}_v$version',
        workflowId: id,
        version: version,
  ...
  FunctionExecution fnExec(String fnId, String suffix, String status, int ms) =>
      FunctionExecution(
        id: 'fnx_$suffix',
        functionId: fnId,
        versionId: '${fnId}_v2',
  ...
  return DemoEntityRepository(
    ...
    functions: [
      fn(
        'fn_normalize',
        'normalize-input',
        'Coerce + trim raw fields',
        'def main(text):\n    return text.strip().lower()',
      ),
      fn(
        'fn_validate',
        'validate-schema',
        'JSON-schema validate a payload',
        'def main(payload):\n    validate(payload)\n    return True',
      ),
      fn(
        'fn_weather',
      ...
      fn(
        kCorpusMentionId,
        kCorpusMentionName,
        'Weather lookup — the corpus wikilink target',
        'def main(city):\n    return api.get(city)',
      ),
      fn(
        'fn_summarize',
        'summarize-text',
        'LLM summarize a document',
    ...
    handlerVersions: {
      'hd_slack': [
        HandlerVersion(
          ...
          initBody: 'self.client = httpx.Client()',
          methods: const [
            MethodSpec(
              name: 'post',
              inputs: [Field(name: 'channel', type: 'string')],
          ...
          envStatus: 'ready',
          changeReason: 'retry loop + region arg',
          createdAt: t1,
          updatedAt: t1,
        ),
        HandlerVersion(
    ...
    agentVersions: {
      'ag_researcher': [
        AgentVersion(
          ...
          version: 3,
          prompt: 'You are researcher. Be precise and cite sources.',
          skill: 'deep-research',
          tools: const [ToolRef(ref: 'mcp:search/web', name: 'web-search')],
          changeReason: 'add web-search tool',
          createdAt: t1,
          updatedAt: t1,
        ),
        AgentVersion(
          ...
          agentId: 'ag_researcher',
          version: 2,
          prompt: 'You are researcher. Cite sources.',
          skill: 'deep-research',
          changeReason: 'tighten prompt',
          createdAt: t1,
          updatedAt: t1,
        ),
        AgentVersion(
    ...
    agentExecutions: {
      'ag_researcher': [
        AgentExecution(
          id: 'agx_1',
          agentId: 'ag_researcher',
          versionId: 'ag_researcher_v3',
          status: 'ok',
          triggeredBy: 'chat',
          input: const {'topic': 'llm agents'},
          output: 'a summary…',
          provider: 'anthropic',
          modelId: 'claude-opus-4-8',
          elapsedMs: 5200,
    ...
    flowruns: {
      'wf_digest': [
        Flowrun(
          id: 'flr_run',
          workflowId: 'wf_digest',
          versionId: 'wf_digest_v2',
          status: 'running',
          replayCount: 0,
          triggerId: 'trg_3a1f',
          startedAt: rt(0),
        ...
        Flowrun(
          ...
          triggerId: 'trg_3a1f',
          startedAt: t1,
          completedAt: t1.add(const Duration(seconds: 9)),
          updatedAt: t1,
        ),
        Flowrun(
          id: 'flr_fail',
          ...
          replayCount: 0,
          triggerId: 'trg_3a1f',
          error: 'run_tests exit code 1',
          startedAt: t0,
          completedAt: t0.add(const Duration(seconds: 4)),
          updatedAt: t0,
        ),
      ],
      ...
      'flr_done': FlowrunComposite(
        ...
        nodes: [
          ...
          FlowrunNode(
            ...
            iteration: 0,
            status: 'completed',
            result: const {'summary': 'draft 1'},
            createdAt: t1,
            completedAt: t1.add(const Duration(seconds: 2)),
            updatedAt: t1,
          ),
          FlowrunNode(
            id: 'd2',
            ...
            completedAt: t1.add(const Duration(seconds: 3)),
            updatedAt: t1,
          ),
          FlowrunNode(
            id: 'd3',
            ...
            iteration: 0,
            status: 'completed',
            result: const {'__port': 'retry', 'score': 0.4},
            createdAt: t1.add(const Duration(seconds: 3)),
            completedAt: t1.add(const Duration(seconds: 3)),
            updatedAt: t1,
          ),
          FlowrunNode(
            ...
            iteration: 1,
            status: 'completed',
            result: const {'summary': 'draft 2'},
            createdAt: t1.add(const Duration(seconds: 3)),
            completedAt: t1.add(const Duration(seconds: 6)),
            updatedAt: t1,
          ),
          FlowrunNode(
            id: 'd5',
            ...
            iteration: 1,
            status: 'completed',
            createdAt: t1.add(const Duration(seconds: 6)),
            completedAt: t1.add(const Duration(seconds: 7)),
            updatedAt: t1,
          ),
          FlowrunNode(
            id: 'd6',
            ...
            iteration: 1,
            status: 'completed',
            result: const {'__port': 'pass', 'score': 0.9},
            createdAt: t1.add(const Duration(seconds: 7)),
            completedAt: t1.add(const Duration(seconds: 7)),
            updatedAt: t1,
          ),
          FlowrunNode(
      ...
      'flr_fail': FlowrunComposite(
        ...
        nodes: [
          ...
          FlowrunNode(
            ...
            status: 'completed',
            createdAt: t0,
            completedAt: t0.add(const Duration(seconds: 2)),
            updatedAt: t0,
          ),
          FlowrunNode(
            id: 'f2',
      ...
      'flr_park': FlowrunComposite(
        ...
        nodes: [
          ...
          FlowrunNode(
            ...
            status: 'parked',
            result: const {
              'rendered': 'Deploy **v2.4.0** to production? 42 files changed.',
            },
            createdAt: t1.add(const Duration(seconds: 3)),
            updatedAt: t1.add(const Duration(seconds: 3)),
          ),
        ],
      ),
    },
    ...
    controlLogics: [
      ControlLogic(
        id: 'ctl_quality',
        name: 'quality-gate',
        description: 'Route on the summary quality score.',
        activeVersionId: 'ctl_quality_v1',
        createdAt: t0,
        updatedAt: t1,
    ...
    approvalForms: [
      ApprovalForm(
        ...
        description: 'Human sign-off before a production deploy.',
        activeVersionId: 'ap_publish_v1',
        createdAt: t0,
        updatedAt: t1,
    ...
    triggerEntities: [
      TriggerEntity(
        id: 'trg_3a1f',
        name: 'nightly-digest',
        description: 'Kick the daily digest at 09:00.',
        kind: TriggerSource.cron,
        config: const {'expression': '0 9 * * *'},
        outputs: const [
          Field(
            name: 'firedAt',
            type: 'string',
        ...
        listening: true,
        lastFiredAt: t1,
        nextFireAt: t1.add(const Duration(hours: 18, minutes: 30)),
        createdAt: t0,
        updatedAt: t1,
      ),
      TriggerEntity(
        id: 'trg_wh1',
        name: 'github-push',
        description: 'Fire when GitHub pushes to main.',
        ...
        outputs: const [
          Field(
            name: 'body',
            type: 'object',
            description: 'Posted body parsed as JSON.',
          ),
        ],
        refCount: 2,
        listening: true,
      ...
      TriggerEntity(
        id: 'trg_fs1',
        name: 'watch-inbox',
        description: 'React to files dropped in the inbox.',
      ...
      TriggerEntity(
        id: 'trg_sn1',
        name: 'queue-depth',
        description: 'Fire when the job queue backs up.',
    ...
    activations: {
      'trg_3a1f': [
        Activation(
          ...
          fired: true,
          firingCount: 1,
          payload: const {'firedAt': '2026-06-25T09:00:00Z'},
          createdAt: t1,
        ),
        Activation(
          id: 'tra_8',
      ...
      'trg_sn1': [
        Activation(
          ...
          fired: true,
          firingCount: 1,
          returnValue: const {'depth': 142},
          detail: 'condition held',
          createdAt: t1,
        ),
        Activation(
          id: 'tra_6',
