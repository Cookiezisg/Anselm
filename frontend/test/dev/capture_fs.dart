...
// Expands each get card to show its four-part exhibit → out/fs.png. F06 get 卡截图夹具(非门禁)。
import 'dart:io';
...
void main() {
  ...
  testWidgets('capture bash', (tester) async {
          ...
          home: Scaffold(
            body: SingleChildScrollView(
              ...
              child: Column(
                ...
                children: [
                  for (final s in toolCardFsGalleryItem.specimens) ...[
                    Builder(
    ...
    for (final f in [find.text('rollup.py'), find.text('quarters.py')]) {
    ...
    File('${dir.path}/fs.png').writeAsBytesSync(bytes);
  });
}
