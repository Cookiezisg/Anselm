...
// Expands each get card to show its four-part exhibit → out/get_cards.png. F06 get 卡截图夹具(非门禁)。
import 'dart:io';
...
import 'package:anselm/dev/gallery/tool_card_get_specimens.dart';
...
void main() {
  ...
  testWidgets('capture get cards', (tester) async {
          ...
          home: Scaffold(
            body: SingleChildScrollView(
              ...
              child: Column(
                ...
                children: [
                  for (final s in toolCardGetGalleryItem.specimens) ...[
                    Builder(
    ...
    for (final v in ['已查看函数', '已查看智能体', '已查看控制', '已查看技能', '已阅读文档']) {
    ...
    File('${dir.path}/get_cards.png').writeAsBytesSync(bytes);
  });
}
