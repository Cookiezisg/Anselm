...
// Expands each get card to show its four-part exhibit → out/term_tail.png. F06 get 卡截图夹具(非门禁)。
import 'dart:io';
...
import 'package:anselm/dev/gallery/an_term_tail_specimens.dart';
...
void main() {
  ...
  testWidgets('capture term tail', (tester) async {
    ...
    File('${dir.path}/term_tail.png').writeAsBytesSync(bytes);
  });
}
