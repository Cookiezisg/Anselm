...
// Expands each get card to show its four-part exhibit → out/bash.png. F06 get 卡截图夹具(非门禁)。
import 'dart:io';
...
void main() {
  ...
  testWidgets('capture bash', (tester) async {
          ...
          home: Scaffold(
            body: SingleChildScrollView(
              ...
              child: Column(
                ...
                children: [
                  for (final s in toolCardShellGalleryItem.specimens) ...[
                    Builder(
    ...
    File('${dir.path}/bash.png').writeAsBytesSync(bytes);
  });
}
