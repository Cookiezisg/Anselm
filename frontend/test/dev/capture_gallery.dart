...
void main() {
  ...
  final cat =
      int.tryParse(const String.fromEnvironment('CAT', defaultValue: '0')) ?? 0;
  ...
  final h =
      double.tryParse(
        const String.fromEnvironment('H', defaultValue: '4200'),
      ) ??
      4200;
  testWidgets('gallery cat $cat — ${galleryCatalog[cat].label}', (
    tester,
  ) async {
