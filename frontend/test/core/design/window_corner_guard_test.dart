...
void main() {
  test(
    'AnRadius.window is concentric with the island (chip + shellPad) and equals the native default 20',
    () {
      ...
      expect(
        ...
        20.0,
        reason:
            'window corner changed — update MainFlutterWindow.swift kANWindowCornerRadius default to match',
      );
    },
  );
}
