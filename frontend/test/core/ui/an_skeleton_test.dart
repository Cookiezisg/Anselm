...
void main() {
  ...
  testWidgets('a11y: labelled "loading" and FINDABLE — but deliberately never announced', (tester) async {
  ...
  testWidgets('a rail of 5 skeleton rows still says nothing (the over-announce case, measured)',
      (tester) async {
    final handle = tester.ensureSemantics();
    final said = probeAnnouncements(tester);
