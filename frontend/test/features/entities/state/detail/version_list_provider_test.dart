...
FunctionVersion _v(int v) =>
    FunctionVersion(id: 'fn_1_v$v', functionId: 'fn_1', version: v, code: 'code v$v', createdAt: _t, updatedAt: _t);
...
void main() {
  test('rows map newest-first with the active flag + select moves the target', () async {
    final c = await _ready(FixtureEntityRepository(
      functions: [FunctionEntity(id: 'fn_1', name: 'f', activeVersionId: 'fn_1_v2', createdAt: _t, updatedAt: _t)],
      functionVersions: {'fn_1': [_v(2), _v(1)]},
    ));
  ...
  test('loadMore appends the next page', () async {
    final c = await _ready(FixtureEntityRepository(
      functions: [FunctionEntity(id: 'fn_1', name: 'f', createdAt: _t, updatedAt: _t)],
      functionVersions: {'fn_1': [for (var i = 25; i >= 1; i--) _v(i)]},
    ));
