...
void main() {
  group('parseGrepContent', () {
    test(
      'multi-file: path:line:text (match) + path-line-text (context), grouped',
      () {
    ...
    test(
      'noise lines (-- separator / truncation / No matches) are dropped',
      () {
  ...
  testWidgets(
    'highlightMatches: the pattern is highlighted; an uncompilable pattern degrades to plain',
    (tester) async {
