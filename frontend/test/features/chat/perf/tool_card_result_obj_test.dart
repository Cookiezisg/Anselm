...
void main() {
  group('C-028 resultObj behaviour', () {
    test('a JSON object decodes to a Map', () {
      expect(_state('{"version":3,"ok":true}').resultObj, {
        'version': 3,
        'ok': true,
      });
    });
  ...
  test(
    'C-028 memoized: the SAME instance returns the SAME decoded Map (identity)',
    () {
      final s = _state('{"a":1}');
  ...
  test(
    'C-028 memoized null: a non-object result caches as null (no re-parse)',
    () {
