...
import { NoApiKeyGate } from "./ui/NoApiKeyGate.tsx";
import { NoModelGate } from "./ui/NoModelGate.tsx";
...
export function ChatPage({ activeConv, onSetActiveConv, onClose, onOpenSettings }: ChatPageProps) {
