...
const mockUseMemories = useMemories as any;
const mockUseUpdateMemory = useUpdateMemory as any;
const mockUseDeleteMemory = useDeleteMemory as any;
const mockUsePinMemory = usePinMemory as any;
...
beforeEach(() => {
  ...
  mockUseUpdateMemory.mockReturnValue({ mutate: updateMutate });
  mockUseDeleteMemory.mockReturnValue({ mutate: delMutate });
  mockUsePinMemory.mockReturnValue({ mutate: pinMutate });
