...
import { ExecuteOverview } from "./ExecuteOverview.tsx";

const mockUseFlowRuns = useFlowRuns as any;
...
beforeEach(() => {
  ...
  mockUseFlowRuns.mockReturnValue({ data: SAMPLE, isLoading: false });
});
...
describe("ExecuteOverview", () => {
  ...
  it("emptyData_kpiStripShowsZero_andNoTableRows", () => {
    mockUseFlowRuns.mockReturnValue({ data: [], isLoading: false });
    render(<ExecuteOverview onOpen={() => {}} />);
  ...
  it("loading_showsLoadingPlaceholder", () => {
    mockUseFlowRuns.mockReturnValue({ data: [], isLoading: true });
    render(<ExecuteOverview onOpen={() => {}} />);
